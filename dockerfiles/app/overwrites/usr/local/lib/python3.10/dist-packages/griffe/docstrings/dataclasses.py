...
class DocstringElement:
    ...
    def __init__(
        self, *, description: str, annotation: str | Expr | None = None
    ) -> None:
...
class DocstringSectionParameters(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringParameter], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionHazards(DocstringSectionParameters):
    """This class represents an hazards section."""

    kind: DocstringSectionKind = DocstringSectionKind.hazards
...
class DocstringSectionRaises(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringRaise], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionWarns(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringWarn], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionReturns(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringReturn], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionYields(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringYield], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionReceives(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringReceive], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionExamples(DocstringSection):
    ...
    def __init__(
        ...
        value: list[
            tuple[
                Literal[
                    DocstringSectionKind.text, DocstringSectionKind.examples
                ],
                str,
            ]
        ],
...
class DocstringSectionAttributes(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringAttribute], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionFunctions(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringFunction], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionClasses(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringClass], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionModules(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringModule], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionDeprecated(DocstringSection):
    ...
    def __init__(
        self, version: str, text: str, title: str | None = None
    ) -> None:
        """Initialize the section.
        ...
        """
        super().__init__(title)
        self.value: DocstringDeprecated = DocstringDeprecated(
...
class DocstringSectionAdmonition(DocstringSection):
    ...
    def __init__(self, kind: str, text: str, title: str | None = None) -> None:
        ...
        """
        super().__init__(title)
        self.value: DocstringAdmonition = DocstringAdmonition(
